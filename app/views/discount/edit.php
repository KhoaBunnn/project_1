...
<div class="container my-5">
    <div class="card shadow-sm rounded p-4" style="border-color: #e67e22;">
        <h2 class="mb-4" style="color: #e67e22;">Sửa mã giảm giá</h2>
        <form method="POST" action="/Project1/Discount/update/<?= $discount->id ?>" class="needs-validation" novalidate>
            <div class="mb-3">
                <label for="code" class="form-label fw-semibold" style="color: #e67e22;">Mã giảm giá:</label>
                <input type="text" id="code" name="code" class="form-control" value="<?= htmlspecialchars($discount->code) ?>" required>
            ...
            <div class="mb-3">
                ...
                <input type="number" id="discount_percent" name="discount_percent" class="form-control" value="<?= $discount->discount_percent ?>" min="0" max="100" required>
            ...
            <div class="mb-4">
                ...
                <input type="date" id="expiry_date" name="expiry_date" class="form-control" value="<?= $discount->expiry_date ?>" required>
